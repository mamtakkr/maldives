...
<div class="portlet-body form" style="min-height: 3700px;">
  ...
  <div class="col-md-10 center-block "> 
    ...
    <div class="form-group last" id="mobileNoLay">
      ...
      <div class="col-md-9">
        <?php
        if(!empty($row->image1)&&file_exists('uploads/maldives/arrival_immigration/'.$row->image1)){ 
          echo '<img src="'.base_url('uploads/maldives/arrival_immigration/'.$row->image1).'" height="50%" width="100%"  />'; 
        } ?>
	...
	<div class="form-group last" id="mobileNoLay">
      ...
      <div class="col-md-9">
         <?php
        if(!empty($row->image2)&&file_exists('uploads/maldives/arrival_immigration/'.$row->image2)){ 
          echo '<img src="'.base_url('uploads/maldives/arrival_immigration/'.$row->image2).'" height="50%" width="100%"  />'; 
        } ?>
	...
	<div class="form-group last" id="mobileNoLay">
      ...
      <div class="col-md-9">
         <?php
        if(!empty($row->image3)&&file_exists('uploads/maldives/arrival_immigration/'.$row->image3)){ 
          echo '<img src="'.base_url('uploads/maldives/arrival_immigration/'.$row->image3).'" height="50%" width="100%"  />'; 
        } ?>
	...
	<div class="form-group last" id="mobileNoLay">
      ...
      <div class="col-md-9">
         <?php
        if(!empty($row->image4)&&file_exists('uploads/maldives/arrival_immigration/'.$row->image4)){ 
          echo '<img src="'.base_url('uploads/maldives/arrival_immigration/'.$row->image4).'" height="50%" width="100%"  />'; 
        } ?>
	...
	<div class="form-group last" id="mobileNoLay">
      ...
      <div class="col-md-9">
        <input type="text" class="form-control input-medium" name="arrival_immigration_link" value="<?php if(set_value('arrival_immigration_link')){ echo set_value('arrival_immigration_link');} else{ if(!empty($row->arrival_immigration_link)){ echo $row->arrival_immigration_link; }} ?>" placeholder="Enter Link" autocomplete="off"/>
        <?php echo form_error('title'); ?> 
      </div>
    </div>
