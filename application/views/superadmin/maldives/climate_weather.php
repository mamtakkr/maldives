...
<div class="portlet-body form" style="min-height: 3700px;">
  ...
  <div class="col-md-10 center-block "> 
    ...
    <div class="form-group last" id="mobileNoLay">
      ...
      <div class="col-md-9">
        <?php
        if(!empty($row->image1)&&file_exists('uploads/maldives/climate_weather/'.$row->image1)){ 
          echo '<img src="'.base_url('uploads/maldives/climate_weather/'.$row->image1).'" height="50%" width="100%"  />'; 
        } ?>
	...
	<div class="form-group last" id="mobileNoLay">
      ...
      <div class="col-md-9">
         <?php
        if(!empty($row->image2)&&file_exists('uploads/maldives/climate_weather/'.$row->image2)){ 
          echo '<img src="'.base_url('uploads/maldives/climate_weather/'.$row->image2).'" height="50%" width="100%"  />'; 
        } ?>
	...
	<div class="form-group last" id="mobileNoLay">
      ...
      <div class="col-md-9">
         <?php
        if(!empty($row->image3)&&file_exists('uploads/maldives/climate_weather/'.$row->image3)){ 
          echo '<img src="'.base_url('uploads/maldives/climate_weather/'.$row->image3).'" height="50%" width="100%"  />'; 
        } ?>
	...
	<div class="form-group last" id="mobileNoLay">
      ...
      <div class="col-md-9">
         <?php
        if(!empty($row->image4)&&file_exists('uploads/maldives/climate_weather/'.$row->image4)){ 
          echo '<img src="'.base_url('uploads/maldives/climate_weather/'.$row->image4).'" height="50%" width="100%"  />'; 
        } ?>
	...
	<div class="form-group last" id="mobileNoLay">
      ...
      <div class="col-md-9">
        <?php
        if(!empty($row->image5)&&file_exists('uploads/maldives/climate_weather/'.$row->image5)){ 
          echo '<img src="'.base_url('uploads/maldives/climate_weather/'.$row->image5).'"  height="50%" width="100%" />'; 
        } ?>
	...
	<div class="form-group last" id="mobileNoLay">
      ...
      <div class="col-md-9">
        <input type="text" class="form-control input-medium" name="climate_weather_link1" value="<?php if(set_value('climate_weather_link1')){ echo set_value('climate_weather_link1');} else{ if(!empty($row->climate_weather_link1)){ echo $row->climate_weather_link1; }} ?>" placeholder="Enter Link" autocomplete="off"/>
        <?php echo form_error('title'); ?> 
      </div>
    </div>
	<div class="form-group last" id="mobileNoLay">
      ...
      <div class="col-md-9">
        <input type="text" class="form-control input-medium" name="climate_weather_link2" value="<?php if(set_value('climate_weather_link2')){ echo set_value('climate_weather_link2');} else{ if(!empty($row->climate_weather_link2)){ echo $row->climate_weather_link2; }} ?>" placeholder="Enter Link" autocomplete="off"/>
        <?php echo form_error('title'); ?> 
      </div>
    </div>
