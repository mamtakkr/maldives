...
<div class="portlet-body form" style="min-height: 3700px;">
  ...
  <div class="col-md-10 center-block "> 
    ...
    <div class="form-group last" id="mobileNoLay">
      ...
      <div class="col-md-9">
        <?php
        if(!empty($row->image1)&&file_exists('uploads/maldives/what_to_wear/'.$row->image1)){ 
          echo '<img src="'.base_url('uploads/maldives/what_to_wear/'.$row->image1).'" height="70%" width="100%"  />'; 
        } ?>
	...
	<div class="form-group last" id="mobileNoLay">
      ...
      <div class="col-md-9">
         <?php
        if(!empty($row->image2)&&file_exists('uploads/maldives/what_to_wear/'.$row->image2)){ 
          echo '<img src="'.base_url('uploads/maldives/what_to_wear/'.$row->image2).'" height="70%" width="100%"  />'; 
        } ?>
	...
	<div class="form-group last" id="mobileNoLay">
      ...
      <div class="col-md-9">
         <?php
        if(!empty($row->image3)&&file_exists('uploads/maldives/what_to_wear/'.$row->image3)){ 
          echo '<img src="'.base_url('uploads/maldives/what_to_wear/'.$row->image3).'"  height="70%" width="100%" />'; 
        } ?>
	...
	<div class="form-group last" id="mobileNoLay">
      ...
      <div class="col-md-9">
         <?php
        if(!empty($row->image4)&&file_exists('uploads/maldives/what_to_wear/'.$row->image4)){ 
          echo '<img src="'.base_url('uploads/maldives/what_to_wear/'.$row->image4).'"  height="70%" width="100%" />'; 
        } ?>
