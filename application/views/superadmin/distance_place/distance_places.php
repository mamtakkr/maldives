...
<section class="content-header tab_header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Distance places List</li>
  </ol>
</section>
<section class="content-header" id="filter_main">
  <form action="<?php echo ADMIN_URL.'openings';?>" method="get">
    <div class="filter_box" style="width:150px">
      ...
      <input type="text" name="opening_id" value="<?php if($this->input->get('place_id')){echo $this->input->get('place_id');}?>" class="form-control"  placeholder="Search Place ID">
    </div>
    <div class="filter_box" style="width:">
      <label>Distance Place Name</label>
            ...
            if(!empty($rows)){
              foreach ($rows as $res_data){?>
                <tr>
                  ...
                  <td class="text-left">
                    <?php  echo !empty($res_data->latitude)? ucfirst($res_data->latitude):'-';?>
                  </td> 
                  <td class="text-left">
                    <?php  echo !empty($res_data->longitude)? ucfirst($res_data->longitude):'-';?>
                  </td>             
                  <td class="text-center"> 
                    <div class="dropdown">
                  ...
                  <td class="text-center"> 
                    <a class="btn btn-sm btn-primary" href="<?php echo ADMIN_URL.'distance_places/add_distance_place/';if(!empty($res_data->id)) echo $res_data->id;?>">
                        <i class="fa fa-pencil" aria-hidden="true"></i>
                     </a>   
                     <a class="btn btn-sm btn-danger" href="javascript:void(0);" onclick="changeStatus('distance_place','distance place','<?php if(!empty($res_data->id)) echo $res_data->id; ?>','3','delete','id','status');");">
