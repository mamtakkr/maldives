...
<section class="content-header" id="filter_main">
  <form action="<?php echo ADMIN_URL.'categorys';?>" method="get">
    ...
    <div class="filter_box" style="width:">
      ...
      <input type="text" name="category_name" value="<?php if($this->input->get('category_name')){echo $this->input->get('category_name');}?>" class="form-control"  placeholder="Search category">
    </div>
    <div class="filter_box" style="width:">
      <label>Order</label>
          ...
          <table class="table table-bordered">
            <tr>
              <head>
                ...
                <th class="text-center">Number of Star</th> 
            ...
            if(!empty($rows)){
              foreach ($rows as $res_data){?>
                <tr>
                  ...
                  <td class="text-center">
                    <?php  echo !empty($res_data->no_of_star)? ucfirst($res_data->no_of_star):'-';?>
                  </td>  
                   <td class="text-left">
                    ...
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        ...
                        <li role="presentation">
                          <a role="menuitem" tabindex="-1" href="javascript:void(0);" onclick="changeStatus('category','category','<?php if(!empty($res_data->id)) echo $res_data->id; ?>','<?php echo $k; ?>','<?php if($k==1){ echo 'activate';}else if($k==3){ echo 'delete';}else{ echo 'deactive';}?>','id','status');">
                            <?php echo $status_a; ?>
                          </a>
                        </li>
                        <?php } 
                  ...
                  <td class="text-center"> 
                    <a class="btn btn-sm btn-primary" href="<?php echo ADMIN_URL.'categorys/add_category/';if(!empty($res_data->id)) echo $res_data->id;?>">
                        <i class="fa fa-pencil" aria-hidden="true"></i>
                     </a>   
                     <a class="btn btn-sm btn-danger" href="javascript:void(0);" onclick="changeStatus('category','category','<?php if(!empty($res_data->id)) echo $res_data->id; ?>','3','delete','id','status');");">
