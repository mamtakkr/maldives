...
<section class="content-header tab_header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Inspiration List</li>
  </ol>
</section>
            ...
            if(!empty($rows)){
              foreach ($rows as $row){?>
                <tr>
                    ...
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                       <li role="presentation">
                          <a role="menuitem" tabindex="-1" href="javascript:void(0);" onclick="changeStatus('mal_inspiration','Inspiration','<?php if(!empty($row->id)) echo $row->id; ?>','<?php echo $k; ?>','<?php if($k==1){ echo 'activate';}else{ echo 'deactive';}?>','id','status');">
                  ...
                  <td class="text-center"> 
                    <a class="btn btn-sm btn-primary" href="<?php echo ADMIN_URL.'pages/add_inspiration/';if(!empty($row->id)) echo $row->id;?>">
                        <i class="fa fa-pencil" aria-hidden="true"></i>
                     </a>   
                     <a class="btn btn-sm btn-danger" href="javascript:void(0);" onclick="changeStatus('mal_inspiration','Inspiration','<?php if(!empty($row->id)) echo $row->id; ?>','3','delete','id','status',1);">
