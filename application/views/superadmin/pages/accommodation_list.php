...
<section class="content-header tab_header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Accommodation List</li>
  </ol>
</section>
                ...
                <tr>
                    ...
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                       <li role="presentation">
                          <a role="menuitem" tabindex="-1" href="javascript:void(0);" onclick="changeStatus('mal_admin_accommodation','Accommodation','<?php if(!empty($row->id)) echo $row->id; ?>','<?php echo $k; ?>','<?php if($k==1){ echo 'activate';}else{ echo 'deactive';}?>','id','status');">
                  ...
                  <td class="text-center"> 
                    <a class="btn btn-sm btn-primary" href="<?php echo ADMIN_URL.'pages/add_accommodation/';if(!empty($row->id)) echo $row->id;?>">
                     ...
                     <a class="btn btn-sm btn-danger" href="javascript:void(0);" onclick="changeStatus('mal_admin_accommodation','Accommodation','<?php if(!empty($row->id)) echo $row->id; ?>','3','delete','id','status',1);">
