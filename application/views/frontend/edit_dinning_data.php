                     ...
                     <div class="col-sm-6">
                        <div class="row">
                           <div class="col-md-3 <?php if(empty($mealRow->meal_served_status)){echo ' left_mr_100';} ?>" id="meal_served_status_up_<?php echo $meal_served->id; ?>">
                              <div class="tick">
                                 <div class="custom-control custom-checkbox">
                                    <input type="checkbox" name="meal_served_status_<?php echo $meal_served->id; ?>" 
                                    value="<?php echo $meal_served->id; ?>" class="custom-control-input" 
                                    id="meal_served_status_<?php echo $meal_served->id; ?>" 
                                    <?php if(!empty($mealRow->meal_served_status)&&$mealRow->meal_served_status==$meal_served->id){echo 'checked';} ?>
