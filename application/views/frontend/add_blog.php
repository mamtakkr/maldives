                                 ...
                                 <div class="form-group">
                                    <div class="file-upload" id="logo_img_main_i">
                                       ...
                                       <div class="image-upload-wrap">
                                          ...
                                          <input class="file-upload-input"  type='file' accept="image/*" id="BannerImg" onchange="uploadLogo();"/>
                                          <div class="drag-text">
                                             <h3>
                                        ...
                                        if(!empty($blog_images)){ 
                                          foreach ($blog_images as $image) {
                                            ...
                                            $deletImg   = "deleteStoryImage('".$randT."','".$image->image_name."', '".$image->id."')";
                                                ...
                                                <img class="file-upload-image" src="' .base_url() . 'uploads/blogs/full_image/1300_'.$image->image_name.'" alt="resort logo">
                                                <div class="image-title-wrap"><button type="button" onclick="'.$deletImg.'" class="remove-image">Remove</button>
                                                </div></div>';
                                              echo $html;
                                            }
                                          }
