         ...
         <div class="form-group">
            <div class="row">
               ...
               if(!empty($villa_types)){
                  ...
                  <div class="col-sm-4">
                     <div class="tick">
                        <div class="custom-control custom-radio villa_type_new">
                           <input type="radio" id="villa_type_n_<?php echo $villa_type->id; ?>" name="villa_type" class="custom-control-input villa_new" value="<?php echo $villa_type->id; ?>" <?php if(!empty($accommodationRow->villa_type)&&$accommodationRow->villa_type==$villa_type->id){echo 'checked';} ?>>
                           <label class="custom-control-label villa_new_edit" for="villa_type_n_<?php echo $villa_type->id; ?>">
                                ...
                                foreach ($images as $image) {
                                    ...
                                    //if(!empty($image->image_name) && file_exists('uploads/resorts/'.$image->image_name)){
                                        ...
                                        $html       =   '<div id="'.$randT.'" class="file-upload-content">
                                                            <img class="file-upload-image" src="' .base_url() . 'uploads/resorts/'.$image->image_name.'" alt="resort logo" />
                                                            <div class="image-title-wrap">
                                                                <button type="button" onclick="'.$deletImg.'" class="remove-image">Remove</button>
                                                            </div>
                                                        </div>';
                                        echo $html;
                                    //}
