<div class="tab-pane fade <?php echo ($this->input->get('type')=='add_blog'||$this->input->get('type')=='blog'||$this->input->get('type')=='story_list')?"":"show active";?>" id="user_profile" role="tabpanel" aria-labelledby="user_profile-tab">
